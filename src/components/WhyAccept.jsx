        ...
        <>
            ...
            <div className='relative '>
                ...
                <div className='text-black flex-col h-[100%]     w-[100%]  px-[8%] flex   md:justify-evenly items-center'>
                    <h1 className=' text-3xl font-semibold'>Why Accept Pe ?</h1>
                        <br />
                    <div className=' grid grid-cols-1 md:grid-cols-3 gap-y-16 '>
                        <div>
                            <img src={plug} alt="" width={40} />
                            <h1 className=' font-bold'>Plug-and-play APIs</h1>
                            <br />
                        ...
                        <div>
                            ...
                            <h1 className=' font-bold'>100% secure and reliable</h1>
                            <br />
                        ...
                        <div>
                            ...
                            <h1 className=' font-bold'>Higher success rates</h1>
                            <br />
                        ...
                        <div>
                            ...
                            <h1 className=' font-bold'> Unified dashboard</h1>
                            <br />
                        ...
                        <div>
                            ...
                            <h1 className=' font-bold'>Quick onboarding</h1>
                            <br />
